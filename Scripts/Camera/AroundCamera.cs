...
public class AroundCamera : CameraAbstract
{
    ...
    protected override void Start()
    {
        ...
        m_PivotEulers = center.rotation.eulerAngles;
        m_PivotTargetRot = center.localRotation;
    ...
    protected override void FollowTarget(float deltaTime)
    {
        ...
        transform.position = Vector3.Lerp(transform.position, targetTransform.position, deltaTime * m_MoveSpeed);
    }
    ...
    private void HandleRotationMovement()
    {
        ...
        {
            center.localRotation = Quaternion.Slerp(center.localRotation, m_PivotTargetRot, m_TurnSmoothing * Time.deltaTime);

            transform.localRotation = Quaternion.Slerp(transform.localRotation, m_TransformTargetRot, m_TurnSmoothing * Time.deltaTime);
        }
        else
        {
            center.localRotation = m_PivotTargetRot;
